...
# UKA!!!
                content << scaffold_check_link('(neu)', true, "new_#{class_name}", associated_params)
...
# UKA:::
        ...
        "<br />#{scaffold_link("#{@scaffold_options[:singular_human_name]} / Cockpit", manage)}" if scaffolded_method?(manage)
